...
exported_pipeline = make_pipeline(
    SimpleAutoencoder(activation="relu", batch_size=15, encoding_dim=50, epochs=50, loss="mean_absolute_error", optimizer="adadelta", random_state = 42),
    RandomForestClassifier(bootstrap=False, criterion="gini", max_features="auto", min_samples_leaf=1, min_samples_split=2, n_estimators=100, random_state=42)
)
