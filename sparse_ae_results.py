...
exported_pipeline = make_pipeline(
    SparseAutoencoder(activation="relu", batch_size=15, encoding_dim=50, epochs=500, loss="mean_absolute_error", optimizer="adadelta", reg_constant=0.0001, regularizer="l2", random_state = 42),
