# -*- coding: utf-8 -*-
"""
Created on Thu Apr 25 15:32:52 2019
...
personal_config = classifier_config_dict
personal_config['sklearn.decomposition.PCA'] = {
...
gens = 1
pop_size = 10
template = "PCA-RandomForestClassifier"
...
simple_aml_results_df.to_csv('pca_aml_results.csv',index=False)
